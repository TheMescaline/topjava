...
public class MealTestData {
    ...
    public static final int LAST_ADMIN_MEAL_ID = 100013;
    ...
    public static final Meal LAST_ADMIN_MEAL = new Meal(LAST_ADMIN_MEAL_ID, LocalDateTime.of(2018, Month.MAY, 23, 20, 0, 0), "Админ Ужин", 1700);
