...
public class MealTestData {
    ...
    public static final List<MealTo> MEALS_TO = MealsUtil.getWithExcess(MEALS, 2000);
    public static final List<MealTo> FILTERED_MEALS_TO = List.of(MealsUtil.createWithExcess(MEAL5, true));
    ...
    public static ResultMatcher containsMealsTo(List<MealTo> expected) {
