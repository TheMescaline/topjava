...
public class MealsUtil {
    ...
    public static final List<Meal> SECOND_USER_MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2016, Month.MARCH, 11, 10, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2016, Month.MARCH, 11, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2016, Month.MARCH, 11, 20, 0), "Ужин", 510),
            new Meal(LocalDateTime.of(2016, Month.MARCH, 12, 10, 0), "Завтрак", 800),
            new Meal(LocalDateTime.of(2016, Month.MARCH, 12, 13, 0), "Обед", 600),
            new Meal(LocalDateTime.of(2016, Month.MARCH, 12, 20, 0), "Ужин", 600)
    );
